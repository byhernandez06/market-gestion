# Project Summary
The project is a comprehensive employee management web application designed for a family-owned mini-supermarket in Costa Rica, aimed at optimizing business operations. It leverages Firebase for secure authentication and real-time data management. The application enables administrators to effectively manage employee schedules, vacations, and extra hours, while providing employees with personalized dashboards to track their work hours and vacation requests, thereby enhancing overall productivity and workflow.
