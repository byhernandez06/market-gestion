# Project Summary
The project is a comprehensive employee management web application designed for a family-owned mini-supermarket in Costa Rica. It leverages Firebase for secure authentication and real-time data management, optimizing business operations. Administrators can manage employee schedules, vacations, and extra hours, while employees enjoy personalized dashboards for vacation requests and work hour tracking, enhancing overall productivity and workflow.
...
- **Schedule Management**: Enables admins to register and visualize employee work schedules with FullCalendar.
