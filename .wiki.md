# Project Summary
The project is a comprehensive employee management web application designed for a family-owned mini-supermarket in Costa Rica. It leverages Firebase for secure authentication and real-time data management, streamlining operations. Administrators can efficiently manage employee schedules, vacations, and extra hours, while employees benefit from personalized dashboards to request vacations and track working hours, ultimately enhancing productivity and workflow.

# Project Module Description
The application consists of several functional modules:
- **Authentication**: Handles user login and role assignments via Firebase Auth.
- **Employee Management**: Admins can create, edit, and delete employee records.
- **Schedule Management**: Admins can register and visualize employee work schedules with FullCalendar.
- **Vacation Management**: Employees can request vacations, with an approval process managed by admins.
