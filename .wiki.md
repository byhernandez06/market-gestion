# Project Summary
The project is a comprehensive employee management web application tailored for a family-owned mini-supermarket in Costa Rica. It leverages Firebase for secure authentication, role management, and real-time data handling, significantly enhancing operational efficiency. The application allows administrators to manage employee schedules, vacations, and extra hours, while employees can access personal information and submit vacation requests, ultimately streamlining organizational workflows and boosting productivity.
