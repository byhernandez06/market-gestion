# Project Summary
The project is a comprehensive employee management web application tailored for a family-owned mini-supermarket in Costa Rica. It leverages Firebase for secure authentication and real-time data handling, streamlining operations. Administrators can efficiently manage employee schedules, vacations, and extra hours, while employees can access personal information and submit vacation requests, enhancing productivity and workflow.
...
- **Dashboard**: Displays role-specific dashboards with real-time statistics.
