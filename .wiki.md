# Project Summary
The project is a comprehensive employee management web application designed for a family-owned mini-supermarket in Costa Rica. It leverages Firebase for secure authentication and real-time data management, streamlining business operations. Administrators can efficiently manage employee schedules, vacations, and extra hours, while employees benefit from personalized dashboards for tracking work hours and vacation requests, ultimately enhancing productivity and workflow.
...
- **src/**: Directory for all source code.
  ...
  - **components/**: Reusable UI components, including the new WeeklyScheduleManager.
