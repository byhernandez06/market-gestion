# Project Summary
The project is a comprehensive employee management web application designed for a family-owned mini-supermarket in Costa Rica. It leverages Firebase for secure authentication and real-time data handling, enhancing operational efficiency. Administrators can manage employee schedules, vacations, and extra hours, while employees can access personal dashboards, request vacations, and track their working hours, thereby improving productivity and workflow.

# Project Module Description
The application consists of several functional modules:
- **Authentication**: Manages user login and role assignments with Firebase Auth.
